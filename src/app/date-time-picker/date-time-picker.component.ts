...
export class DateTimePickerComponent
  ...
  ngOnInit(): void {
    ...
    // console.log("ngOnInit datetime", this.datetime);
    // console.log("ngOnInit inputDatetimeFormat", this.inputDatetimeFormat);
    // console.log("ngOnInit dtStr >"+this.dtStr+"<");
  ...
  setDateStringModel() {
    // console.log("setDateStringModel dtStr in >"+this.dtStr+"<");
    //let dateStringPrev: string = this.dtStr;
    // console.log("setDateStringModel  dateStringPrev >"+dateStringPrev+"<");
...
/*    if (!this.firstTimeAssign) {
    ...
    if (this.datetime.year == 1800) {
      this.dateString = "";
      //dateStringPrev === "" ? this.dtStr = "?" : this.dtStr = "";
      this.dtStr = "";
    }
    //console.log("setDateStringModel dateString: ",this.dateString);
    this.outDate.emit(this.dateString);
    /*
    if (this.datetime.year == 1800 && dateStringPrev.length !== 0 && dateStringPrev.trim().length !== 0 ) {
      this.dtStr = "?";
      // console.log("setDateStringModel1 dtStr >"+this.dtStr+"<");
    }
    if (this.datetime.year == 1800 && dateStringPrev.length !== 0 && dateStringPrev.trim().length === 0 ) {
      dateStringPrev === "  " ? this.dtStr = "?" : this.dtStr = dateStringPrev + "?";
      // console.log("setDateStringModel2 dtStr >"+this.dtStr+"<");
    }
    */
    // console.log("setDateStringModel dtStr >"+this.dtStr+"<");
    // console.log("setDateStringModel inputDatetimeFormat", this.inputDatetimeFormat);
  }
